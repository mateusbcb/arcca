...
<html lang="en">
	...
	<head>
		...
		<link href="/res/admi/assets/css/pages/login/login-2.css" rel="stylesheet" type="text/css" />

		<!--end::Page Custom Styles -->

		<!--begin::Global Theme Styles(used by all pages) -->
		<link href="/res/admi/assets/plugins/global/plugins.bundle.css" rel="stylesheet" type="text/css" />
		<link href="/res/admi/assets/css/style.bundle.css" rel="stylesheet" type="text/css" />

		<!--end::Global Theme Styles -->

		<!--begin::Layout Skins(used by all pages) -->
		<link href="/res/admi/assets/css/skins/header/base/light.css" rel="stylesheet" type="text/css" />
		<link href="/res/admi/assets/css/skins/header/menu/light.css" rel="stylesheet" type="text/css" />
		<link href="/res/admi/assets/css/skins/brand/dark.css" rel="stylesheet" type="text/css" />
		<link href="/res/admi/assets/css/skins/aside/dark.css" rel="stylesheet" type="text/css" />
					...
					<div class="kt-grid__item kt-grid__item--fluid kt-login__wrapper">
						<div class="kt-login__container">
							<div class="kt-login__logo">
								<a href="#">
									<img src="/res/admin/assets/media/logos/logo-mini-2-md.png">
								</a>
							</div>
